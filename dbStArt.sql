...
CREATE TABLE tblEspecialidadeArtista (
  idEspecialidadeArtista INT NOT NULL AUTO_INCREMENT,
  nomeEspecialidadeArtista VARCHAR(100) NOT NULL,
  PRIMARY KEY (idEspecialidadeArtista),
  UNIQUE INDEX (idEspecialidadeArtista)
);
...
CREATE TABLE tblArtista (
  ...
  idEspecialidadeArtista INT NOT NULL,
  fotoPerfilArtista VARCHAR(250) NULL,
  PRIMARY KEY (idArtista),
  UNIQUE INDEX (idArtista),
  CONSTRAINT fk_tblArtista_tblEspecialidadeArtista
    FOREIGN KEY (idEspecialidadeArtista)
    REFERENCES tblEspecialidadeArtista (idEspecialidadeArtista)
);
...
CREATE TABLE tblFormaPagto (
  idFormaPagto INT NOT NULL AUTO_INCREMENT,
...
CONSTRAINT fk_tblPagamento_tblCompra
	...
	REFERENCES tblCompra (idCompra),
      CONSTRAINT fk_tblPagamento_tblProposta
	FOREIGN KEY (idProposta)
	REFERENCES tblProposta (idProposta),
...
INSERT INTO tblEstado (nomeEstado) 
VALUES
('Acre'),
('Alagoas'),
('Amazonas'),
...
INSERT INTO tblCidade (idCidade, nomeCidade, idEstado) VALUES
(1, 'Afonso Cláudio', 8),
...
--         VALUES('ff','fd43243243','40-B','Jardim São João',1);
--         
